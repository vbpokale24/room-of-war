...
public class Enemy extends Character implements Serializable{
	...
	private static final long serialVersionUID = -9011544407506871010L;
	...
	/**Constructs object of {@code Enemy} 
	 * @param name
	 * @param role
	 * @param health
	 * @param experience
	 ...
	 * @param weapons
	 */
	public Enemy(String name, String role, Integer health, Integer experience, boolean isPoisonous, Integer rating,
			List<String> weapons) {
	...
	public String toString() {
		return "Enemy [name=" + name + ", role=" + role + ", health=" + health + ", experience=" + experience
				+ ", isPoisonous=" + isPoisonous + ", rating=" + rating + ", weapons=" + weapons + "]";
	}
